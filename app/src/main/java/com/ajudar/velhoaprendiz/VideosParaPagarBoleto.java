...
public class VideosParaPagarBoleto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_videos_para_pagar_boleto);
        ...
        iconeSair.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(VideosParaPagarBoleto.this, "Você saiu!", Toast.LENGTH_SHORT).show();
        ...
        iconeAjuda.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder msg = new AlertDialog.Builder(VideosParaPagarBoleto.this);
                msg.setTitle("Ajuda");
